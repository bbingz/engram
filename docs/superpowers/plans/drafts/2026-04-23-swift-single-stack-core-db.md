...
- [ ] Preserve the current non-destructive behavior for removed Viking columns: do not attempt to drop old columns in this stage.
...
- Read reference: `package.json`
- Read reference: `docs/archive/viking-removal-plan.md`
