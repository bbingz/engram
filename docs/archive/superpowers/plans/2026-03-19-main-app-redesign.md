...
```bash
mkdir -p /Users/bing/-Code-/coding-memory/macos/Engram/Components
```
...
```bash
cd /Users/bing/-Code-/coding-memory && npm run build
```
Expected: No errors.
...
```bash
cd /Users/bing/-Code-/coding-memory && npm run dev &
sleep 2
...
```bash
mkdir -p /Users/bing/-Code-/coding-memory/macos/Engram/Views/Pages
```
