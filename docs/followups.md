...
| **ADAPTER-TRUNCATION-METADATA-001** / export P1 remainder | this PR | Cline whole-transcript reads report `truncatedAt` / `totalKnownComplete=false` when they exceed `ParserLimits.maxMessages`. VS Code, Cursor, and Gemini CLI stay later slices. |
