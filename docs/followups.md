...
| **ADAPTER-EMPTY-SESSION-001E** / R184-3 | this PR | Kimi wire/context metadata with no user/assistant/tool turns returns `.noVisibleMessages`. Remaining adapters stay later slices. |
