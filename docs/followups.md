...
| **INDEXER-BACKPRESSURE-001** / L17 | closed (#330) | `SwiftIndexer.indexAll` awaits each full 100-snapshot write inside the scan callback; shipped at `main@53bd4cc4`. |
...
| **ANTIGRAVITY-CWD-REREAD-001** / L34 | closed (#327) | Antigravity CWD inference reads at most 50KB with bounded handle; shipped at `main@ddf2070a`. |
