...
| **ADAPTER-EMPTY-SESSION-001B** / R184-3 | this PR (#358) | CommandCode and Iflow injection-only files now return `.noVisibleMessages` after a valid session id, matching Qwen. Remaining adapters stay later slices. |
