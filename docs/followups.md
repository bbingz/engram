...
| **ADAPTER-PARSEINFO-CAP-001F** / export P1 remainder | this PR | Qoder `parseSessionInfo` called `readObjects` without `reportFailures`, so an oversized transcript returned prefix counts as complete. |
