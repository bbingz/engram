...
| **ADAPTER-INDEX-BACKFILL-CAP-001** / export P1 remainder | this PR | Instruction and implementation-beat backfill use `streamMessagesWithMetadata` and fail closed when the adapter reports truncation, instead of writing prefix counts/beats as complete. |
