...
| **HOME-BADGE-001** / L16 | closed (#319) | Home Changed Repos badge now clamps with `todayPanelRowLimit` and matches rendered rows (`macos/Engram/Views/Pages/HomeView.swift`); named `_repro` in `HomePopoverActionsTests`. |
