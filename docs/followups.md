...
| **MESSAGEPARSER-METADATA-001** / #39 | this PR (#420) | `MessageParser.adapterMessages` called `streamMessages`, so Iflow/CommandCode/Qoder cap throws fell through to uncapped `parseLegacy`. Use `streamMessagesWithMetadata` and keep the bounded prefix. |
