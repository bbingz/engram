...
|----|--------|------------------|
| **R1** / ARCH-001 | open (partially mitigated) | Triple Read SQL stacks remain; unify shared list/search/cost predicates in CoreRead and add cross-surface parity fixtures |
