...
| **ANTIGRAVITY-CWD-REREAD-001** / L34 | implemented / verified; PR pending | Antigravity CWD inference reads at most the first 50,000 transcript bytes with a file handle and preserves the existing path heuristic, including safe UTF-8 prefix-boundary handling. |
