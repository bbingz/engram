...
| **ADAPTER-PARSEINFO-CAP-001E** / export P1 remainder | this PR | CommandCode `parseSessionInfo` called `readObjects` without `reportFailures`, so an oversized transcript returned prefix counts as complete. |
