...
| **ADAPTER-TRUNCATION-METADATA-001E** / export P1 remainder | closed (#375) | Copilot checkpoint `index.md` whole-transcript reads report `truncatedAt` / `totalKnownComplete=false` when they exceed `ParserLimits.maxMessages`. Truncation-metadata adapter series complete, including checkpoint locators. Shipped at `main@9cac0311`. |
