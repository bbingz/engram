...
| **ADAPTER-STREAM-INJECTION-001** / L10 | implemented / verified; PR #341 open | CommandCode, Qwen, Qoder, and Iflow streaming now reuse their batch-path injection classifiers, emit injected wrappers as system, and preserve the real first-user summary/count (`CommandCodeAdapter.swift:167-180`; `QwenAdapter.swift:196-208`; `QoderAdapter.swift:178-200`; `IflowAdapter.swift:156-172`). Four named regressions in `AdapterMessageCountTests.swift:670-1128,3674-3711` pin the role/count parity contract. |
