...
| **HOME-BADGE-001** / L16 | implemented / verified; PR #319 open | Home Changed Repos badge now clamps with `todayPanelRowLimit` and matches rendered rows (`macos/Engram/Views/Pages/HomeView.swift`); named `_repro` in `HomePopoverActionsTests`. |
