...
| **ADAPTER-PARSEINFO-CAP-001C** / export P1 remainder | this PR (#391) | Qwen `parseSessionInfo` called `readObjects` without `reportFailures`, so an oversized transcript returned prefix counts as complete. |
