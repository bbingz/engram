...
| **ADAPTER-TAIL-TERMINAL-001** / R184-4 | this PR | Tail-parse terminal policy matches `FileIndexState.isTerminalFailure`. `malformedJSON` / `invalidUtf8` / `fileMissing` fall through to a full scan; `noVisibleMessages` stays terminal. |
