...
| **ADAPTER-STREAM-WHOLE-CAP-001E** / export P1 remainder | this PR (#415) | Iflow `streamMessages` used `windowedMessages`, which swallows `.messageLimitExceeded` when `limit == nil`, so an oversized transcript streamed a prefix as complete. |
