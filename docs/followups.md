...
| **ADAPTER-TRUNCATION-METADATA-001C** / export P1 remainder | this PR | Cursor whole-transcript reads report `truncatedAt` / `totalKnownComplete=false` when they exceed `ParserLimits.maxMessages`. Gemini CLI stays a later slice. |
