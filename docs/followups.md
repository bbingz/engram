...
| **ADAPTER-TRUNCATION-METADATA-001E** / export P1 remainder | this PR (#375) | Copilot checkpoint `index.md` whole-transcript reads report `truncatedAt` / `totalKnownComplete=false` when they exceed `ParserLimits.maxMessages`. |
