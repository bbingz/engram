...
| **WORKGRAPH-FORMATTER-001** / L15 | implemented / verified; PR #324 open | WorkGraph idle/status coloring uses `EngramTimestampParser` instead of per-row `ISO8601DateFormatter()`; source `_repro` pins the contract. |
