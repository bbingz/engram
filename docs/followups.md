...
| **ADAPTER-STREAM-WHOLE-CAP-001B** / export P1 remainder | this PR (#409) | Qwen `streamMessages` called `readObjects` without `reportFailures`, so an oversized transcript streamed a prefix as complete. |
