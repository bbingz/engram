...
| **ADAPTER-TRUNCATION-METADATA-001B** / export P1 remainder | this PR (#371) | VS Code whole-transcript reads report `truncatedAt` / `totalKnownComplete=false` when they exceed `ParserLimits.maxMessages`. Cursor and Gemini CLI stay later slices. |
