...
| **ADAPTER-STREAM-WHOLE-CAP-001C** / export P1 remainder | this PR (#411) | Windsurf `streamMessages` called `readCache` without `reportFailures`, so an oversized Cascade cache streamed a prefix as complete. |
