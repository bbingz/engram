...
| **ADAPTER-PARSEINFO-CAP-001D** / export P1 remainder | this PR (#393) | Iflow `parseSessionInfo` called `readObjects` without `reportFailures`, so an oversized transcript returned prefix counts as complete. |
