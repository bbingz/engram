...
| **FTS-H01-TS-001** / L20 | implemented / verified; PR #337 open | Retained TypeScript version-3 finalize now copies eligible live FTS rows missing from the shadow table and refuses an incomplete swap, matching the Swift H01 guard (`src/core/db/fts-rebuild-policy.ts:63-89,194-250`). `tests/core/db.test.ts:229` preserves terminal-job live content through the swap. |
