...
| **DOCS-INDEX-RETENTION-001** / L23 | implemented / verified; PR #339 open | `docs/archive/README.md:7-38` and `docs/reviews/README.md:7-42` provide scoped navigation, current-authority boundaries, and explicit no-age-only-deletion retention rules. `tests/docs/history-index-policy.test.ts:9-35` pins the contract. |
...
| **SCHEMA-TOOL-DEAD-001** / L35 | implemented / verified; PR #336 open | Removed the uncalled `EngramCoreSchemaTool` sources, XcodeGen target, and generated target/scheme. `AppSearchServiceCutoverScanTests.swift:972` pins the source-of-truth and generated-project absence contract. |
