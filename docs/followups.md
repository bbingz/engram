...
| **ADAPTER-EMPTY-SESSION-001F** / R184-3 | this PR (#362) | Timestamped Cline metadata-only files (`api_req_started` with no task/text) return `.noVisibleMessages`. Remaining adapters stay later slices. |
