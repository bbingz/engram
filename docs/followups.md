...
| **ADAPTER-TRUNCATION-METADATA-001D** / export P1 remainder | closed (#373) | Gemini CLI whole-transcript reads report `truncatedAt` / `totalKnownComplete=false` when they exceed `ParserLimits.maxMessages`. Truncation-metadata adapter series complete. Shipped at `main@eaecb430`. |
