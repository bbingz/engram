...
| **ADAPTER-PARSEINFO-CAP-001B** / export P1 remainder | this PR | Codex `parseSessionInfo` called `readObjects` without `reportFailures`, so an oversized transcript returned prefix counts as complete. |
