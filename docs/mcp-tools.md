...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| query | string | **yes** | Search keywords; 1-character queries return no matches; 2-character Latin and CJK use LIKE fallback |
