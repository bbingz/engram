...
| 52 | DOCS-INDEX-RETENTION-001 | low | `docs/archive` and `docs/reviews` lack scoped indexes and an explicit retention policy (L23) | implementer | Both directories document navigation, current-authority boundaries, and no age-only deletion; `indexes archive and review evidence with explicit retention rules_repro` pins the policy | **IMPLEMENTED / VERIFIED — PR #339 OPEN** 2026-08-13 — `docs/archive/README.md:7-38`; `docs/reviews/README.md:7-42`; `tests/docs/history-index-policy.test.ts:9-35`. |
...
| 52 | DOCS-INDEX-RETENTION-001 | low | Archive and review evidence lacked scoped indexes and an explicit retention policy (L23) | **IMPLEMENTED / VERIFIED — PR #339 OPEN** |
