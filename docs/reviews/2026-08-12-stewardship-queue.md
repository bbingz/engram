...
| 31 | ARCH-001 | debt | Triple Read SQL stacks / shared CoreRead predicates | implementer | Shared predicate module + cross-surface parity suite | **PARTIAL — A/B/C DONE; D IMPLEMENTED / PR PENDING**: ARCH-001A shared search predicates (#311), ARCH-001B list/aggregate convergence (#312), and ARCH-001C residual list visibility (#313) shipped. ARCH-001D now executes the first App/Service/MCP keyword parity contract. Full CoreRead pool/DTO migration remains deferred structural work; ARCH-001 stays open. |
...
| 62 | ARCH-001D-PARITY | debt | First executable App/Service/MCP keyword-search parity fixture | **IMPLEMENTED / VERIFIED — PR PENDING** |
