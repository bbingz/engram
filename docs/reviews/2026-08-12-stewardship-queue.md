...
| 65 | SETTINGS-MAINACTOR-IO-001 | low | AI settings debounce still performs flock/Keychain I/O on MainActor after the timer (R9 residual) | implementer | Snapshot on MainActor, persist Keychain + settings.json off-main; leave-flush still lands; named `_repro` | **THIS PR** — #356 |
