...
const sessions: SeedSession[] = [
  ...
  // 7: Gemini, premium tier with generated_title + summary
  {
    ...
    systemMessageCount: 0,
    summary:
      'Implemented full Viking bridge integration with dual-write support and circuit breaker pattern',
    ...
    origin: 'local',
    tier: 'premium',
    generatedTitle: 'Viking Bridge Integration',
    qualityScore: 90,
  },
