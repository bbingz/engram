...
final class ParentDetectionParityTests: XCTestCase {
        ...
        for item in fixture.scoreCases {
            ...
            case "same-project-active-parent":
                actual = ParentDetection.scoreCandidate(
                    ...
                    agentCwd: "/Users/bing/-Code-/engram",
                    parentCwd: "/Users/bing/-Code-/engram"
                )
    ...
    func testCandidateScoringCwdAndTimeRules() {
        ...
        let exactCwd = ParentDetection.scoreCandidate(
            ...
            agentProject: nil,
            parentProject: nil,
            agentCwd: "/Users/bing/-Code-/gemini-plugin-cc",
            parentCwd: "/Users/bing/-Code-/gemini-plugin-cc"
        )
        let unrelatedCloser = ParentDetection.scoreCandidate(
            ...
            parentProject: nil,
            agentCwd: "/Users/bing/-Code-/gemini-plugin-cc",
            parentCwd: "/Users/bing/-Code-/sscms-audit"
        )
        ...
        XCTAssertGreaterThan(
            ParentDetection.scoreCandidate(
                ...
                agentProject: "Zhiwei",
                parentProject: nil,
                agentCwd: "/Users/bing/-Code-/Zhiwei",
                parentCwd: "/Users/bing/-Code-/Zhiwei"
            ),
            0
        )
