...
enum MCPOutputSchemas {
    ...
    private static let listSessionItem =
        #"{"type":"object","additionalProperties":false,"required":["id","source","origin","startTime","endTime","cwd","project","model","messageCount","userMessageCount","summary","tier","parentSessionId"],"properties":{"id":{"type":"string"},"source":{"type":"string"},"origin":{"type":["string","null"]},"startTime":{"type":"string"},"endTime":{"type":"string"},"cwd":{"type":"string"},"project":{"type":["string","null"]},"model":{"type":["string","null"]},"messageCount":{"type":"integer"},"userMessageCount":{"type":"integer"},"summary":{"type":["string","null"]},"tier":{"type":["string","null"]},"parentSessionId":{"type":["string","null"]}}}"#
    ...
    static let projectTimeline = j(
        #"{"type":"object","additionalProperties":false,"required":["project","timeline","total","hasMore"],"properties":{"project":{"type":"string"},"total":{"type":"integer"},"hasMore":{"type":"boolean"},"timeline":{"type":"array","items":{"type":"object","additionalProperties":false,"required":["time","source","summary","sessionId","messageCount"],"properties":{"time":{"type":"string"},"source":{"type":"string"},"summary":{"type":"string"},"sessionId":{"type":"string"},"messageCount":{"type":"integer"}}}}}}"#
    )
