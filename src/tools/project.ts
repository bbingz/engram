...
export const projectReviewTool = {
  name: 'project_review',
  description:
    'Scan the 6 AI session roots for residual references to an old project ' +
...
export interface TruncatedReviewResult {
  own: string[];
  other: string[];
...
// ---------- loadBatchFile re-export (for non-MCP use cases) ----------
// Not a tool; Phase 5 may expose a file-path variant once remote MCP is no longer a concern.
export { loadBatchFile };
