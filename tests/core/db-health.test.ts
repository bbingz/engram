...
describe('getSourceStats', () => {
  ...
  it('returns per-source stats with daily counts', () => {
    ...
    db.upsertSession({
      ...
      assistantMessageCount: 2, toolMessageCount: 0, systemMessageCount: 0, sizeBytes: 100,
    } as any)
    db.upsertSession({
      id: 's2', source: 'claude-code', filePath: '/tmp/s2', cwd: '/tmp',
      startTime: yesterday, messageCount: 3, userMessageCount: 2,
      assistantMessageCount: 1, toolMessageCount: 0, systemMessageCount: 0, sizeBytes: 80,
    } as any)
    db.upsertSession({
      id: 's3', source: 'codex', filePath: '/tmp/s3', cwd: '/tmp',
      startTime: today, messageCount: 2, userMessageCount: 1,
      assistantMessageCount: 1, toolMessageCount: 0, systemMessageCount: 0, sizeBytes: 50,
    } as any)
