...
- [变更] #234 exact local head `9da69b63` 已把 lint-staged 17.0.8 升到 17.2.0；依赖/lockfile 与真实 `git commit` 失败探针已核实，本地 Node 全量门禁通过，未保留 hook/test 改动。fresh PR CI 仍待推送触发，多文件/特殊 glob/non-TTY 场景未单独验证；完整收据与风险见 `CHANGELOG.md`。
